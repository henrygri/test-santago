        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <div class="col-md-12">
                        <form action="{{ route('bandi.store') }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="codice" value="{{ old('codice') }}" name="codice" placeholder="{{ __('Es: XC678') }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="data_apertura" value="{{ old('data_apertura') }}" name="data_apertura" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="data_chiusura">{{ __('Data chiusura') }} *</label>
                                        <input type="date" class="form-control" id="data_chiusura" value="{{ old('data_chiusura') }}" name="data_chiusura" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="data_chiusura_prorogata">{{ __('Data chiusura prorogata') }}</label>
                                        <input type="date" class="form-control" id="data_chiusura_prorogata" value="{{ old('data_chiusura_prorogata') }}" name="data_chiusura_prorogata">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="monte_ore" value="{{ old('monte_ore') }}" name="monte_ore">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control number_format" id="valore_iniziale" value="{{ old('valore_iniziale') }}" name="valore_iniziale" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control number_format" id="valore_finale" value="{{ old('valore_finale') }}" name="valore_finale">
                                            <span class="input-group-text">€</span>
                                        </div>
                                    </div>
                                </div>
