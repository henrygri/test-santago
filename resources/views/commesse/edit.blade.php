    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Modifica Commessa</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">{{ __('Modifica Commessa') }}</div>
                        ...
                        <form action="{{ route('commesse.update', $commessa->id) }}" method="post">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="user_id">{{ __('Responsabile Commessa') }}</label>
                                    <select id="user_id" name="user_id" class="form-control">
                                        <option></option>
                                        @foreach($users as $user)
                                        <option value="{{$user->id}}" {{$commessa->user_id == $user->id ? 'selected' : ''}}>{{$user->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="stato">{{ __('Codice') }} *</label>
                                        <input type="text" value="{{ $commessa->codice }}" class="form-control" name="codice" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select id="stato" name="stato" class="form-control" required>
                                            ...
                                            <option value="Annullata" {{ $commessa->stato == 'Annullata' ? 'Annullata' : '' }}>Annullata</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="offerta_id" name="offerta_id" class="form-control" required>
                                            ...
                                            <option value="{{$offerta->id}}"  {{ $offerta->id == $commessa->offerta_id ? 'selected' : '' }}>{{$offerta->codice}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="company_id" name="company_id" class="form-control" required>
                                            <option></option>
                                            <option value="{{$commessa->company->id}}" selected>{{$commessa->company->rag_soc}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select id="customer_id" name="customer_id" class="form-control" required>
                                                <option></option>
                                                <option value="{{$commessa->customer->id}}" selected>{{$commessa->customer->nome}} {{$commessa->customer->cognome}}</option>
                                            </select>
                                            <button type="button" class="btn btn-outline-secondary" onclick="openModalReferente()">
                                                Aggiungi
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea id="description" name="description" class="form-control" required>{{ $commessa->description }}</textarea>
                                </div>
                                <div class="col-md-12 mt-3">
                                    ...
                                    <select id="service_id" name="service_id[]" class="form-control select2" multiple disabled>
                                        @foreach($services as $service)
                                            <option value="{{$service->id}}" {{in_array($service->id, $commessa->services) ? 'selected' : ''}}>{{$service->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" value="{{ $commessa->data_apertura }}" class="form-control" id="data_apertura" name="data_apertura" readonly required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input 
                                            type="date" 
                                            min="{{ $commessa->data_apertura }}"
                                            value="{{ $commessa->data_stim_chiusura }}" 
                                            class="form-control" id="data_stim_chiusura" 
                                            name="data_stim_chiusura" 
                                            required
                                            @role('admin') @else readonly @endrole>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="data_effettiva_chiusura">{{ __('Data effettiva chiusura') }}</label>
                                        <input type="date" min="{{ $commessa->data_apertura }}" value="{{ $commessa->data_effettiva_chiusura }}" class="form-control" id="data_effettiva_chiusura" name="data_effettiva_chiusura">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{ $commessa->val_iniziale }}" class="form-control number_format" id="val_iniziale" name="val_iniziale" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{ $commessa->val_finale }}" class="form-control number_format" id="val_finale" name="val_finale">
                                            <span class="input-group-text">€</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{  $commessa->val_no_finanz }}" class="form-control number_format" id="val_no_finanz" name="val_no_finanz">
                                            <span class="input-group-text">€</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{ $commessa->val_finanz }}" class="form-control number_format" id="val_finanz" name="val_finanz">
                                            <span class="input-group-text">€</span>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="newReferente" tabindex="-1" aria-labelledby="newReferenteLabel" aria-hidden="true">
...
<script>
    ...
    const getOffertaBando = (offerta_id) => {
    ...
    $(document).ready(function(){
        ...
        getOffertaBando( $('#offerta_id').val());
