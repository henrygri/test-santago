...
<div class="container-fluid pt-3">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Aggiungi Collaboratore') }}</div>
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('user.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('Es: Paolo Rossi') }}" value="{{ old('name') }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="16" class="form-control" id="fiscal_code" name="fiscal_code" placeholder="{{ __('Es: ABCDEF89G04H123I') }}" required>
                            </div>
                            <div class="form-group">
